...
namespace JehovaJireh.Web.Services.Controllers
{
  ...
  //              var r = dto.InjectFrom<DeepCloneInjection>(dto);
  ...
  //              //        RequestedBy = item.RequestedBy != null ? new UserDto {
  ...
  //              //                RequestedBy = line.Donation.RequestedBy != null? new UserDto
  //              //                {
  ...
  //              //            },
  //              //            RequestedBy = line.RequestedBy!= null ?new UserDto { 
  ...
  //              //                    RequestedBy = image.Item.RequestedBy!=null? new UserDto {
